param(
    ...
    [string]$OutputDir = "..\..\outputs\v1.1.4"
)
...
$portable = Join-Path $output "LowLatencyCaptureViewer_v1.1.4_x64"
$zip = Join-Path $output "LowLatencyCaptureViewer_v1.1.4_x64.zip"
