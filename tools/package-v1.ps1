param(
    [string]$BuildDir = "..\build-v106-release",
    [string]$OutputDir = "..\outputs\v1.0.6"
)
...
$portable = Join-Path $output "LowLatencyCaptureViewer_v1.0.6_x64"
$zip = Join-Path $output "LowLatencyCaptureViewer_v1.0.6_x64.zip"
