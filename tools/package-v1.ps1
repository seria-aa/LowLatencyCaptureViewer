param(
    [string]$BuildDir = "..\build-v1171-release",
    [string]$OutputDir = "..\outputs\v1.1.7.1"
)
...
$portable = Join-Path $output "LowLatencyCaptureViewer_v1.1.7.1_x64"
$zip = Join-Path $output "LowLatencyCaptureViewer_v1.1.7.1_x64.zip"
