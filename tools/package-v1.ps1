param(
    ...
    [string]$OutputDir = "..\..\outputs\v1.1.3"
)
...
$portable = Join-Path $output "LowLatencyCaptureViewer_v1.1.3_x64"
$zip = Join-Path $output "LowLatencyCaptureViewer_v1.1.3_x64.zip"
