param(
    [string]$BuildDir = "..\build-v110-release",
    [string]$OutputDir = "..\outputs\v1.1.0"
)
...
$portable = Join-Path $output "LowLatencyCaptureViewer_v1.1.0_x64"
$zip = Join-Path $output "LowLatencyCaptureViewer_v1.1.0_x64.zip"
