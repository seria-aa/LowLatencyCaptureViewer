param(
    [string]$BuildDir = "..\build-v1062-release",
    [string]$OutputDir = "..\outputs\v1.0.6.2"
)
...
$portable = Join-Path $output "LowLatencyCaptureViewer_v1.0.6.2_x64"
$zip = Join-Path $output "LowLatencyCaptureViewer_v1.0.6.2_x64.zip"
