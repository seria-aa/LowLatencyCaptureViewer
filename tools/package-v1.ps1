param(
    [string]$BuildDir = "..\build-v1061-release",
    [string]$OutputDir = "..\outputs\v1.0.6.1"
)
...
$portable = Join-Path $output "LowLatencyCaptureViewer_v1.0.6.1_x64"
$zip = Join-Path $output "LowLatencyCaptureViewer_v1.0.6.1_x64.zip"
