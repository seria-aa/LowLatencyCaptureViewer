param(
    [string]$BuildDir = "..\build-v115-release",
    [string]$OutputDir = "..\..\outputs\v1.1.5"
)
...
$portable = Join-Path $output "LowLatencyCaptureViewer_v1.1.5_x64"
$zip = Join-Path $output "LowLatencyCaptureViewer_v1.1.5_x64.zip"
