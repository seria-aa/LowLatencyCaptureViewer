param(
    ...
    [string]$OutputDir = "..\outputs\v1.0.0"
)
...
$portable = Join-Path $output "LowLatencyCaptureViewer_v1.0.0_x64"
$zip = Join-Path $output "LowLatencyCaptureViewer_v1.0.0_x64.zip"
