...
`build\Release` 실행 파일을 v1.2.12으로 패키징하는 예시입니다. 릴리스 스크립트의
...
생성 파일은 `..\outputs\v1.2.12\LowLatencyCaptureViewer_v1.2.12_Setup.exe`와
`..\outputs\v1.2.12\LowLatencyCaptureViewer_v1.2.12_x64.zip`입니다. 다른 버전은
