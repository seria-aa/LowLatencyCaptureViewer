...
`build\Release` 실행 파일을 v1.2.9으로 패키징하는 예시입니다. 릴리스 스크립트의
...
생성 파일은 `..\outputs\v1.2.9\LowLatencyCaptureViewer_v1.2.9_Setup.exe`와
`..\outputs\v1.2.9\LowLatencyCaptureViewer_v1.2.9_x64.zip`입니다. 다른 버전은
