...
영상 모드에서는 `F3`으로 오디오 미터 OSD를 표시하거나 숨길 수 있습니다.
오디오 전용 모드는 별도의 상시 표시 화면에서 마스터 음량, L/R 피크·채널 음량,
클리핑 상태를 보여줍니다. L/R 카드의 마우스 휠 음량 조절과 두 번 클릭 초기화는
영상 OSD와 동일하게 사용할 수 있습니다.
...
**단축키·진단** 탭에서 **진단 로그 파일 저장**을 켜면 다음 위치에 기록됩니다.
