...
- Tearing 허용 또는 VSync 선택
- WASAPI Shared/Exclusive 출력과 기본 장치 추적 또는 특정 장치 고정
...
| 항목 | 권장 시작값 |
| --- | --- |
| 화면 표시 방식 | 최저 표시 지연은 Tearing 허용. 화면 찢어짐을 막으려면 VSync. |
| 오디오 모드 | 호환성을 위해 WASAPI Shared부터 사용. 장치가 지원하면 Exclusive를 시험. |
