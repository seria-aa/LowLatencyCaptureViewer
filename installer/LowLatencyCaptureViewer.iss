; Low Latency Capture Viewer v1.2.5.1
...
#define BuildDir "..\build-v1251-release"
...
OutputDir=..\..\outputs\v1.2.5.1
OutputBaseFilename=LowLatencyCaptureViewer_v1.2.5.1_Setup
Compression=lzma2
