; Low Latency Capture Viewer v1.1.7.2
...
#define BuildDir "..\build-v1172-release"
...
OutputDir=..\..\outputs\v1.1.7.2
OutputBaseFilename=LowLatencyCaptureViewer_v1.1.7.2_Setup
Compression=lzma2
