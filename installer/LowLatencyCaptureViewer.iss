...
#define BuildDir "..\build-v1062-release"
...
OutputDir=..\..\outputs\v1.0.6.2
OutputBaseFilename=LowLatencyCaptureViewer_v1.0.6.2_Setup
Compression=lzma2
