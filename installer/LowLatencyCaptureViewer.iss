; Low Latency Capture Viewer v1.1.7.1
...
#define BuildDir "..\build-v1171-release"
...
OutputDir=..\..\outputs\v1.1.7.1
OutputBaseFilename=LowLatencyCaptureViewer_v1.1.7.1_Setup
Compression=lzma2
