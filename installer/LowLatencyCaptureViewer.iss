...
#define BuildDir "..\build-v1061-release"
...
OutputDir=..\..\outputs\v1.0.6.1
OutputBaseFilename=LowLatencyCaptureViewer_v1.0.6.1_Setup
Compression=lzma2
