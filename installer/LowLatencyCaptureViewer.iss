; Low Latency Capture Viewer v1.1.4
...
#define BuildDir "..\..\audio-osd-refactor-build\Release"
...
OutputDir=..\..\outputs\v1.1.4
OutputBaseFilename=LowLatencyCaptureViewer_v1.1.4_Setup
Compression=lzma2
